...
### MVP Features v2.1 - Bug Fixes & Enhancements:
...
- `GET /api/google/search?query=` - Search Google Business profiles (MOCK)
- `POST /api/google/connect` - Connect Google Business
- **NEW:** `GET /api/facebook/search?query=` - Search Facebook Pages (MOCK)
