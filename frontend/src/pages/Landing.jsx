...
export default function Landing() {
  ...
  // Industries data for carousel - Enhanced with competitive advantage details
  const industriesData = [
    {
      name: "Restaurants, Cafés & QSRs",
      icon: ShoppingCart,
      impact: "+25–40% Footfall",
      impactType: "Direct uplift in footfall & delivery orders",
      description: "Integrate Swiggy/Zomato/Google reviews in one dashboard. Use table QR codes to capture post-meal feedback instantly. AI responses to positive reviews build social proof; 'Reputation Shield' catches service issues privately before they deter 31+ review-readers. Higher ratings = top placement in food delivery apps → 30–50% more order visibility.",
    ...
    },
    {
      ...
      impactType: "Direct bookings & premium pricing power",
      description: "Manage Google/Facebook reviews alongside OTA feedback. Responding within hours (via AI) signals attentive management—critical for 84% of travelers who check recent reviews. Fix negative experiences privately via Reputation Shield before they spread. A 0.5-star rating increase can justify 8–12% room rate premium.",
      color: "from-blue-500 to-indigo-500",
    },
    {
      name: "Salons, Spas & Beauty Clinics",
      icon: Sparkles,
      impact: "+20–35% Retention",
      impactType: "Repeat customer rate increase",
      description: "QR codes at checkout counters prompt immediate reviews while satisfaction is peak. AI responses personalize appreciation ('Loved your new highlights!'). High-volume positive reviews build trust for high-consideration services. A jump from 4.1 → 4.7 stars converts hesitant first-timers into loyal clients.",
    ...
    },
    {
      ...
      impactType: "New patient acquisition via local search",
      description: "89% of patients research doctors online before booking. Google review dominance is non-negotiable. ReviewMaster's private feedback routing lets clinics resolve billing/appointment issues before public complaints damage reputation. Timely AI responses show empathy and professionalism—critical for trust-based decisions.",
    ...
    },
    {
      ...
      icon: Zap,
      impact: "+30% Retention",
      impactType: "Higher customer retention & referral rate",
      description: "Post-service QR codes on invoices capture feedback when service quality is fresh. Negative reviews about delays/parts pricing are routed privately—allowing instant resolution ('We'll refund ₹500 for the wait'). Public 5-star reviews mentioning 'honest pricing' or 'no hidden charges' directly counter industry skepticism and drive footfall.",
    ...
    },
    {
      ...
      impactType: "Local footfall + omnichannel credibility",
      description: "Bridge online-offline trust gap. Collect Google/Facebook reviews in-store via QR codes; simultaneously manage Amazon/Flipkart seller ratings. A unified 4.5+ star presence across platforms signals reliability. Customers checking 'near me' searches convert 3x faster when seeing recent positive local reviews.",
    ...
    },
    {
      ...
      impactType: "Booking conversion from Google searches",
      description: "High-stakes, urgent-need services rely entirely on review trust. One 1-star review about 'overcharging' can kill business. Reputation Shield catches complaints instantly for damage control. AI responses to 5-star reviews ('Glad we fixed your monsoon leak!') build community trust. Top-rated listings get 70% more click-throughs in Google Local Pack.",
      color: "from-amber-500 to-orange-500",
    },
    {
      name: "Fitness Centers & Yoga Studios",
      icon: TrendingUp,
      impact: "+22% Retention",
      impactType: "Reduction in membership churn",
      description: "Post-class QR codes capture emotional high-points ('Best session ever!'). Consistent 4.8+ ratings overcome gym-hesitation. Negative feedback about cleanliness/equipment is resolved privately before going viral. Social proof via recent Google reviews drives trial class sign-ups—critical for conversion to paid memberships.",
    ...
    },
    {
      ...
      impactType: "Faster property closures & agent credibility",
      description: "Client testimonials on Google/Facebook directly influence vendor/buyer trust. AI-crafted responses to reviews mentioning 'transparent process' or 'found my dream home' become social proof assets. Agencies with 50+ recent 5-star reviews receive 3x more inbound leads versus competitors with sparse/no reviews.",
    ...
    },
    {
      ...
      impactType: "Higher conversion rate on product pages",
      description: "Centralized monitoring of Amazon/Flipkart reviews identifies product issues early (e.g., 'zipper broke'). Sellers respond professionally to negative reviews ('DM us for replacement')—improving perceived accountability. Products maintaining 4.3+ stars rank higher in search results, directly increasing organic sales volume.",
    ...
    },
    {
      ...
      impactType: "Enrollment surge during admission season",
      description: "Parents intensely research via Google reviews. Timely responses to queries in reviews ('Do you offer transport?') answered publicly build transparency. Reputation Shield prevents isolated parent complaints from escalating. A steady stream of recent 5-star reviews mentioning 'caring teachers' or 'visible progress' drives admission inquiries.",
    ...
    },
    {
      ...
      impactType: "Premium pricing acceptance for highly-rated tours",
      description: "Travel decisions hinge on recent experiences. ReviewMaster aggregates Google/Facebook reviews mentioning specific destinations/guides. AI responses thanking reviewers for 'capturing Rann of Kutch beautifully' create aspirational social proof. Operators with 100+ recent 5-star reviews command 10–15% higher tour fees.",
  ...
  return (
    <div className="min-h-screen animated-bg overflow-hidden">
      ...
      {/* Industries We Serve - Auto-Scrolling Horizontal Carousel */}
      <section className="py-16 sm:py-24 px-0 bg-gradient-to-b from-slate-50 to-white overflow-hidden">
