...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen animated-bg overflow-hidden">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-indigo-600 via-purple-600 to-violet-700 relative overflow-hidden">
        {/* Background decorations */}
        ...
        <div className="absolute top-1/4 right-1/4 w-32 h-32 bg-amber-400/20 rounded-full blur-2xl" />
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white tracking-tight mb-4 sm:mb-6">
                ...
                <span className="block text-amber-300">Reputation Report</span>
              </h2>
              <p className="text-base sm:text-lg text-indigo-100 mb-6 sm:mb-8 max-w-lg">
                Discover how your business appears online. Our AI-powered analysis shows your rating trends, competitor comparison, and actionable insights to boost your reviews.
              </p>
              
              {/* Benefits List */}
              <div className="space-y-3 mb-8">
                {[
                  "Your current Google rating & review count",
                  "Sentiment analysis of recent reviews",
                  "Competitor rating comparison",
                  "Top keywords customers mention",
            ...
            >
              <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-2xl">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-2">Get Your Free Report</h3>
                  <p className="text-sm text-slate-500">Takes less than 30 seconds</p>
                </div>
                
                <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); toast.success("Report request submitted! Check your email shortly."); }}>
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1.5">Business Name</label>
                    <input
                      type="text"
                      placeholder="e.g., Bella Coffee House"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1.5">Google Business URL (Optional)</label>
                    <input
                      type="url"
                  ...
                  <Button
                    type="submit"
                    className="w-full py-6 text-base font-semibold rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all"
                  >
              ...
              {/* Floating badge */}
              <div className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 bg-amber-400 text-amber-900 px-3 py-1 rounded-full text-xs sm:text-sm font-bold shadow-lg">
                100% FREE
              </div>
            </motion.div>
          </div>
